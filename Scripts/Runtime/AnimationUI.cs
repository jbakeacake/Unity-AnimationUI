...
namespace Unity_AnimationUI.Scripts.Runtime
{
    ...
    public class AnimationUI : MonoBehaviour
    {
        ...
        IEnumerator PlayAnimation()
        {
            ...
            for (int i = 0; i < this.atTimeEvents.Count; i++)
                this.StartCoroutine(this.AtTimeEvent(this.atTimeEvents[i], this.atTimes[i])); //Function to call at time
                ...
                if (sequence.SequenceType == Sequence.Type.Animation)
                {
                    ...
                    if (sequence.TargetType == Sequence.ObjectType.RectTransform)
                    {
                        if (sequence.TargetRtTask.HasFlag(Sequence.RtTask.AnchoredPosition))
                            this._coroutines.Add(this.StartCoroutine(this.TaskAnchoredPosition(
                        ...
                        if (sequence.TargetRtTask.HasFlag(Sequence.RtTask.LocalEulerAngles))
                            this._coroutines.Add(this.StartCoroutine(this.TaskLocalEulerAngles(
                                sequence.TargetComp.GetComponent<RectTransform>(),
                        ...
                        if (sequence.TargetRtTask.HasFlag(Sequence.RtTask.LocalScale))
                            this._coroutines.Add(this.StartCoroutine(this.TaskLocalScale(
                                sequence.TargetComp.GetComponent<RectTransform>(),
                        ...
                        if (sequence.TargetRtTask.HasFlag(Sequence.RtTask.AnchorMax))
                            this._coroutines.Add(this.StartCoroutine(this.TaskAnchorMax(
                                sequence.TargetComp.GetComponent<RectTransform>(),
                        ...
                        if (sequence.TargetRtTask.HasFlag(Sequence.RtTask.AnchorMin))
                            this._coroutines.Add(this.StartCoroutine(this.TaskAnchorMin(
                                sequence.TargetComp.GetComponent<RectTransform>(),
                        ...
                        if (sequence.TargetRtTask.HasFlag(Sequence.RtTask.SizeDelta))
                            this._coroutines.Add(this.StartCoroutine(this.TaskSizeDelta(
                                sequence.TargetComp.GetComponent<RectTransform>(),
                        ...
                        if (sequence.TargetRtTask.HasFlag(Sequence.RtTask.Pivot))
                            this._coroutines.Add(this.StartCoroutine(this.TaskPivot(
                                sequence.TargetComp.GetComponent<RectTransform>(),
                    ...
                    else if (sequence.TargetType == Sequence.ObjectType.Transform)
                    {
                        if (sequence.TargetTransTask.HasFlag(Sequence.TransTask.LocalPosition))
                            this._coroutines.Add(this.StartCoroutine(this.TaskLocalPosition(
                                sequence.TargetComp.transform,
                    ...
                    else if (sequence.TargetType == Sequence.ObjectType.Image)
                    {
                        if (sequence.TargetImgTask.HasFlag(Sequence.ImgTask.Color))
                            this._coroutines.Add(this.StartCoroutine(this.TaskColor(
                                sequence.TargetComp.GetComponent<Image>(),
                        ...
                        if (sequence.TargetImgTask.HasFlag(Sequence.ImgTask.FillAmount))
                            this._coroutines.Add(this.StartCoroutine(this.TaskFillAmount(
                                sequence.TargetComp.GetComponent<Image>(),
                    ...
                    else if (sequence.TargetType == Sequence.ObjectType.CanvasGroup)
                    {
                        if (sequence.TargetCgTask.HasFlag(Sequence.CgTask.Alpha))
                            this._coroutines.Add(this.StartCoroutine(this.TaskAlpha(
                    ...
                    else if (sequence.TargetType == Sequence.ObjectType.Camera)
                    {
                        if (sequence.TargetCamTask.HasFlag(Sequence.CamTask.BackgroundColor))
                            this._coroutines.Add(this.StartCoroutine(this.TaskBackgroundColor(
                        ...
                        if (sequence.TargetCamTask.HasFlag(Sequence.CamTask.OrthographicSize))
                            this._coroutines.Add(this.StartCoroutine(this.TaskOrthographicSize(
                                sequence.TargetComp.GetComponent<Camera>(),
                    ...
                    else if (sequence.TargetType == Sequence.ObjectType.TextMeshPro)
                    {
                        if (sequence.TargetTextMeshProTask.HasFlag(Sequence.TextMeshProTask.Color))
                            this._coroutines.Add(this.StartCoroutine(this.TaskTextMeshProColor(
                        ...
                        if (sequence.TargetTextMeshProTask.HasFlag(Sequence.TextMeshProTask.MaxVisibleCharacters))
                            this._coroutines.Add(this.StartCoroutine(this.TaskMaxVisibleCharacters(
                                sequence.TargetComp.GetComponent<TMP_Text>(),
                                (float) sequence.MaxVisibleCharactersStart, (float) sequence.MaxVisibleCharactersEnd,
                ...
                if (sequence.SequenceType == Sequence.Type.Animation)
                {
                    ...
                    else if (sequence.TargetType == Sequence.ObjectType.TextMeshPro)
                    {
                        ...
                        if (sequence.TargetTextMeshProTask.HasFlag(Sequence.TextMeshProTask.MaxVisibleCharacters))
                            this._coroutines.Add(this.StartCoroutine(this.TaskMaxVisibleCharacters(
                                sequence.TargetComp.GetComponent<TMP_Text>(),
                                sequence.MaxVisibleCharactersStart, sequence.MaxVisibleCharactersEnd, sequence.Duration,
                                sequence.EaseFunction
                            )));
                    }
                }
        ...
        void EditorUpdate()
        {
            ...
            {
                if (this.UpdateSequence != null && this.IsPlayingInEditMode)
                    this.UpdateSequence(this.TotalDuration); //Make sure the latest frame is called
